...
const login = catchAsync(async (req, res) => {
  ...
  const { user, accessToken, plainRefreshToken } = await AuthService.login(
    email,
    password,
    req,
  );
...
const refreshToken = catchAsync(async (req, res) => {
  ...
  const result = await SessionService.validateAndRotateRefreshToken(
  ...
  sendSuccess(res, httpStatus.OK, "Token refreshed successfully", {
